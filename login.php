...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid ">
            <div class ="card">
                <div class="container-fluid">
                    <h4>Login as a Restaurant</h4>
                    <h6 class="text-muted">Customers and Restaurants have mutual login</h6>
                    <?php
                    if ( $failure !== false ) 
                    {
                        echo(
                    ...
                    <h6 class="text-muted">New to Foodshala, 
                        <a class="btn btn-outline-dark" href="signuprestaurant.php" role="button">Signup as Restaurant</a> | 
                        <a class="btn btn-outline-dark" href="signupcustomer.php" role="button">Signup as Customer</a>
                    </h6>
                </div>
            </div>
        </div>
