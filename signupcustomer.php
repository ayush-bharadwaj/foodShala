...
<html lang="en">
    <head>
        ...
        <title>Foodshala | Signup as Customer</title>
    </head>
    <body>
        ...
        <div class="container-fluid ">
            <div class ="card">
                <div class="container-fluid">
                    ...
                    <h6 class="text-muted">New to Foodshala but not a Customer, 
                        <a class="btn btn-outline-dark" href="signuprestaurant.php" role="button">Signup as Retaurant</a>
                    </h6>
                </div>
            </div>
        </div>
