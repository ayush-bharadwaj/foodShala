...
<html lang="en">
    <head>
        ...
        <title>Foodshala | Signup as Restaurant</title>
    </head>
    <body>
        ...
        <div class="container-fluid ">
            <div class ="card">
                <div class="container-fluid">
                    <h4>Sign-Up as a Restaurant</h4>
                    <h6 class="text-muted">Customers and Restaurants have different Sign-Up pages</h6>
                    <?php
                        if ( $failure !== false ) 
                        {
                            echo(
                    ...
                    <h6 class="text-muted">New to Foodshala but not a Restaurant, 
