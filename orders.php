...
try {
    ...
    $stmt = $conn->prepare("SELECT menu.itemName, users.userName, menu.itemPreference FROM menu, users, orders WHERE orders.customerId=users.userId AND orders.itemId=menu.itemId AND menu.itemRestaurantId=$restaurantId");
    $stmt->execute();
    $result = $stmt->setFetchMode(PDO::FETCH_ASSOC);
    echo $result['itemName'];
    echo $result['userName'];
    echo $result['itemPreference'];
} 
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link <?php echo $disabled;?>" href="#" >Check Order</a>
                    </li>
                    &nbsp;
        ...
        <div class="container-fluid">
            ...
            <thead>
              <tr>
                ...
                <th scope="col">Item Preference</th>
              </tr>
            </thead>
            <tbody>';
